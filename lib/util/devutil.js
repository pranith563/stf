...
devutil.makeIdentity = function(serial, properties) {
  ...
  var socModel = properties['ro.soc.model'] ||
        properties['ro.boot.platform_name']
  var socManufacturer = properties['ro.soc.manufacturer']
  ...
  , socModel: socModel ? socModel.toUpperCase() : null
  , socManufacturer: socManufacturer || null
